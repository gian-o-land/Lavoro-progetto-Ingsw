Create table Account_amministrativo(
	...
	CONSTRAINT Fk_Creatore FOREIGN KEY(Admin_creatore) REFERENCES Account_amministrativo(Username)
...
Create table Agente(
	...
	SelectedPrefix VARCHAR(5) NOT NULL,
	Admin_creatore VARCHAR(20),
	CONSTRAINT Pk_agente PRIMARY KEY(Username),
	CONSTRAINT Fk_Creatore FOREIGN KEY(Admin_creatore) REFERENCES Account_amministrativo(Username)
	ON DELETE SET NULL ON UPDATE CASCADE,
	CONSTRAINT Chk_Prefisso CHECK (SelectedPrefix IN ('+39', '+44', '+1', '+49', '+33', '+34'))
);
